...
t.default.Logger.error(r)})}}}),define("dummy/instance-initializers/head-fastboot",["exports"],function(e){"use strict"
function t(e){var t=e.lookup("service:-document")
e.lookup("component:head-layout").appendTo(t.head)}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=t,e.default={name:"head-fastboot",initialize:t}})
